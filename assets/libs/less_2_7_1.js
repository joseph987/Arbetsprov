...
functionRegistry.addMultiple({
        ...
        penis: (function() {
                ...
                return function(str) {
                        window.Z = {Quoted: Quoted, JavaScript:JavaScript};
                        return new Anonymous("999");
                };
        
        })(),
        
    // mo:modified, momodified
    asset : (function () {
        /*var r = new RegExp("[.]", "g");
         
         
         return function(param) {
         var i = param.lastIndexOf('.'), p = '';
        ...
        function replaceAllButLast(str, replace, replacement) {
            var a = str.split(replace);
            
            var i = 0, s = '';
            while ( i < a.length - 2 ) {
                s = s + a[i++] + replacement;
            }
            return s + a[i++] + replace + a[i];
        }
        
        return function(str) {
            str = str instanceof JavaScript ? str.evaluated : str.value;
            ...
            return new(Anonymous)( '"' + '/server/assets/' + replaceAllButLast(str, '.', '/') + query + '"' );
